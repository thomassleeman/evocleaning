...
if (isset($_POST['submit'])) {
  ...
  $data = [
    'secret' => "6LcBP6QaAAAAAMoeA-B75aGXQ6B9A1gZbM7Ll0_W",
  ...
  header("Location: message-sent.html#thank-you-message");
    ...
    try {
          ...
          //Content
          $mail->isHTML(true);                                 
          $mail->Subject = "New quotation request recieved at ". date("H:i"). " on ". date("l d/m/Y");
          $mail->Body    = '<b>Quotation Request Details:</b> <br><br> <b>Name:</b> '.$name.'<br><br> <b>Company:</b> '.$companyname.'<br><br> <b>Tel:</b> '.$tel. '<br><br> <b>Email:</b> '.$email. '<br><br> <b>Postcode:</b> '.$postcode. '<br><br> <b>Hours:</b> '.$hours. '<br><br> <b>Message:</b> '.$message. '<br><br> <b>Recaptcha Score (0-1): </b>'.$res['score'];
